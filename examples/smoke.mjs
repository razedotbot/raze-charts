...
const styleBtn2 = [...sb2.querySelectorAll("button")].find((b) => b.getAttribute("aria-label")?.startsWith("Chart type"));
...
const indBtn2 = [...sb2.querySelectorAll("button")].find((b) => b.getAttribute("aria-label") === "Indicators");
